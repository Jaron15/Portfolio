...
function HeaderText() {
  return (
    ...
    transition={{staggerChildren: 0.8}} className='w-fit self-center'>
      ...
      <motion.div animate={bottomTextAnimate} className='text-neutral-400 w-full text-left text-4xl md:text-5xl lg:text-6xl mx-auto whitespace-nowrap'>Full Stack Developer</motion.div>
      </motion.div>
      </div>
  ) 
}
